...
class ROSMonitor:
    def __init__(self):
        ...
        self.racecarSocket.bind(('10.0.X.0',self.pos_broadcast_port)) # NEED TO FIND ADDRESS TO BIND!
    ...
    def broadcastFrequency_cb(self, event):
        vehiculePosPack = pack(positionFormat,self.pos[0],self.pos[1],self.pos[2],self.id) # Convert string to binary
        self.racecarSocket.sendto(vehiculePosPack,("10.0.X.255",self.pos_broadcast_port)) # Send vehicule position NEED TO FIND ADDRESS!
    ...
    def rr_loop(self):
        ...
        self.rr_socket.bind(('10.0.X.0',self.remote_request_port)) # NEED TO FIND ADDRESS TO BIND!
